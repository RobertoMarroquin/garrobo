...
class FacturaCF(models.Model):
    ...
    numeroControlInternoDel = models.CharField("Numero de Control Interno (DEL)", max_length=8,blank=True, null=True)
    numeroControlInternoAl = models.CharField("Numero de Control Interno (AL)", max_length=8,blank=True, null=True)
